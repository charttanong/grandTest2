...
<head>
    ...
    <style>
        ...
        @media (max-width: 576px) {
            ...
            #head-scroll>.col-10 {
                width: 100% !important;
                /* make column full width on small devices */
            }
        ...
        #spinner {
            opacity: 0;
            visibility: hidden;
            transition: opacity 1.5s ease-out 0.5s, visibility 0s linear 2s;
            z-index: 99999;
        }
        ...
        #spinner.show {
            opacity: 1;
            visibility: visible;
            transition: opacity 1.5s ease-out 0s, visibility 0s linear 0s;
        }
    </style>
...
<body>
    ...
    <?php
        ...
        if (isset($_GET['slug'])) {
            ...
            // Prepare the query to get a specific article by slug
            $stmt = $conn->prepare("SELECT * FROM empirearticle WHERE slug = ?");
                ...
                <link href="https://cdn.quilljs.com/1.3.7/quill.snow.css" rel="stylesheet">
                    ...
                    <style>
                        ...
                        .article-content p {
                            ...
                            margin-right: 20px; /* Add specific right margin */
                        }
                        ...
                        .article-content {
                            ...
                            overflow-wrap: break-word; /* Allows long words or URLs to break */
                        }
                ...
                <body>
                    <div class="article-container">
                        ...
                        <div class="article-author">
                            Author : <?= htmlspecialchars_decode($article['author']) ?>
                        </div>
                    </div>
                </body>
                </html>
            ...
            echo "<p>No article slug provided.</p>";
        }
        ?>
    </div>
